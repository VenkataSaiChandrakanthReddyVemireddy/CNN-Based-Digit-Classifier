...
Original file is located at
    https://colab.research.google.com/drive/1TptjghLfVULUwGnJuIZ-6gmfJq7twcPg
"""
...
(x_train, labels_train),(x_test, labels_test) = mnist_data.load_data()#Spliting dataset b/w train and test set
...
# # Generate new augmented data
# for new_x_test, y in datagen.flow(x_test.reshape(x_test.shape[0], 28, 28, 1),y_test,batch_size=num,shuffle=False):
#     break

# new_y_test = y.flatten()
# new_y_test = to_categorical(new_y_test, 10)
